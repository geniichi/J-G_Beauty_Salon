...
<main>
    ...
    <div>
        ...
        <?php
            ...
            // echo (empty($_GET["search"])) ? "Empty<br>" : "Not Empty<br>";
            // echo "Supplier: " . $_GET["supplier"] . "<br>";
            // echo "Product Class: " . $_GET["productClass"] . "<br>";
            // echo "Sort On: " . $_GET["sortOn"] . "<br>";
            // echo "Sort By: " . $_GET["sortBy"] . "<br>";
            // echo isset($_GET["submit"]) ? "submitted<br>" : "not submitted<br>";
